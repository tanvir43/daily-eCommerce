...
urlpatterns = [
        ...
        path('category/<int:slug>/detail', views.CategoryDetailAPIView.as_view(), name='category-detail'),
        ...
        path('products/<int:slug>/edit', views.ProductUpdateAPIView.as_view(), name='product-update'),
        path('products/<int:slug>/delete', views.ProductDetailAPIView.as_view(), name='product-delete'),
]
